...
function hideSearch() {
    ...
    document.getElementById("search-button").style.visibility = "visible"  // show search icon
    document.activeElement.blur() // remove focus from search box 
    searchVisible = false
}

function showSearch() {
    document.getElementById("search-button").style.visibility = "hidden"  // hide search icon
